...
# ╔═╡ 62e0fe19-d957-40e1-bd22-26d48b7318c0
...
begin
	etym_data = "../data/etym.text"
	etym = extract_etym(etym_data)
end

# ╔═╡ e9ddaa82-11e1-4bc2-98cd-ec01c881f343
begin
	def_data = "../data/def.text"
	def = extract_def(def_data)
end

# ╔═╡ 6ed29980-2056-4fe3-8b9c-3771242ffed7
function clean_etym(df::DataFrame)
	words = unique(etym, [:word])[!, :word]
	# res = filter(:word => ==("word"), etym)
end

# ╔═╡ aa27c133-cc6a-4b0c-ac19-dd9503e01fa4
clean_etym(etym)
